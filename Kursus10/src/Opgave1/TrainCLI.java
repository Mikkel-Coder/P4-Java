 ...
 * The Traincli class
 * 
 * This class is mostly a copy form the previously lectures except for the 
 * addition of Events in the method `add` and `remove`.
 */
...
public class TrainCLI implements Runnable {
	...
	private List<TrainCLIEvents> listeners = new ArrayList<TrainCLIEvents>();
	...
	public void addListener(TrainCLIEvents listener) {
	...
	private void remove() {
		for (TrainCLIEvents listener : listeners) {
