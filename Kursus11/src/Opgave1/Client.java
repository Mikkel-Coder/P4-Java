/*
 * Consider the client code from previous course module exercise, what type 
 * of errors can you envision. Write at least three fault possibilities.
 */
...
public class Client implements X_TrainCLIEvents {
	...
	public void updateLocalTrainsList() {
		...
		/* THIS IS THE IMPORTANT BITS ABOUT EXPECTIONS */
		} catch (IOException e) {
